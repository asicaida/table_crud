...
<!--						<li class="item"><a href="<?php //echo \core\URL::generar("viajes"); ?>" title="Revista">Viajes</a></li>-->
						<?php echo \core\HTML_Tag::li_menu("item", array("viajes"), "Viajes"); ?>
		...
		<div id="pie">
			...
			Documento creado por Dayana Asimbaya Caiza . <a href="mailto:dayana.sofia23@gmail.com">Contactar</a><br />
			Fecha última actualización: 31 de enero de 2014.
		</div>
